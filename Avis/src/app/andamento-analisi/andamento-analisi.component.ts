...
@Component({
  selector: 'app-andamento-analisi',
  templateUrl: './andamento-analisi.component.html',
  styleUrls: ['./andamento-analisi.component.css']
})
export class AndamentoAnalisiComponent implements OnInit {
